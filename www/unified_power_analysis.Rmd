...
An alternative hypothesis, e.g., a disease model, determines the the trio of quantities implicitly,
...
Power can also be calculated by directly prescribing the trio $(\phi, f, R)$, and the sample size.
