...
On the other hand, the canonical parameters are invariant to the disease model choices, and accomadate models falling outside the usual categories. 
...
We make another minor comment regarding practical usage of disease models.
...
Depending on the use cases, either approach may have an edge.
Neither is decidedly better than the other. 
...
- When designing a follow-up / confirmatory study, or conducting a systematic review:
    - Choose the approach for which parameter estimates are available, or of better quality.
...
The minor comments we made about the two approaches should not be taken as criticisms, but rather as warnings for users of the power analysis tools.
